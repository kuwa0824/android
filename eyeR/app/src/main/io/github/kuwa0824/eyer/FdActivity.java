package io.github.kuwa0824.eyer;
...
public class FdActivity extends CameraActivity implements CvCameraViewListener2 {
    ...
    private io.github.kuwa0824.eyer.DetectionBasedTracker mNativeDetector;
            ...
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    try {
                        ...
                        mNativeDetector = new io.github.kuwa0824.eyer.DetectionBasedTracker(mCascadeFile.getAbsolutePath(), 0);
                        cascadeDir.delete();
